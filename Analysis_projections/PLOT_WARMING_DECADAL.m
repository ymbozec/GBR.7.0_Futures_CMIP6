...
for ssp = 1:5
    ...
    % p1=plot(YEARS(17:end), mean(F_8DHW,1),'-','Color',rgb('Rosybrown'),'LineWidth',2);
    % hold on
    % p2=plot(YEARS(17:end), mean(F_12DHW,1),'-','Color',rgb('IndianRed'),'LineWidth',2);
    % p3=plot(YEARS(17:end), mean(F_16DHW,1),'-','Color',rgb('Indigo'),'LineWidth',2);
    % p4=plot(YEARS(17:end), mean(F_20DHW,1),'-','Color',rgb('Black'),'LineWidth',2);
